...
//The IoTEnvironment gather all the functions that an environment can implement.
type IoTEnvironment interface {
	StartEnvironment(con MongoDB) (err error)
}

//Here an instance of an IoTEnvironment is created.
var EnvironmentInstance IoTEnvironment

//The StartDevice function will register a new environment in the database.
